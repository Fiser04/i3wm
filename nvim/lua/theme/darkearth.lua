...
local theme = lush(function(injected_functions)
    ...
    return {
        Normal({ fg = hsl(46, 51, 68), bg = "NONE"}),
        ...
        Directory({ fg = hsl(71, 27, 40), bg = "NONE"}),
        ...
        ModeMsg({ gui = "bold" }),
        LineNr({ fg = hsl(71, 27, 40), bg = "NONE"}),
        DefLineNr({ fg = lnfg, bg = "NONE"}),
        LineNrAbove({ DefLineNr }),
        LineNrBelow({ DefLineNr }),
        CursorLineNr({ fg = hsl(46, 51, 68), gui = "bold", bg = "NONE"}),
        FzfLuaCursorLineNr({ CursorLineNr }),
        Question({ fg = hsl(120, 17, 45), gui = "bold" }),
        StatusLine({ fg = hsl(46, 51, 68), gui = "bold", bg = "NONE"}),
        ...
        SignColumn({ fg = hsl(20, 5, 40), bg = "NONE"}),
        ...
        TabLine({ fg = hsl(20, 5, 40), bg = "NONE" }),
        TabLineSep({ fg = "NONE", bg = "NONE"}),
        TabLineSelSep({ fg = hsl(72, 27, 40), gui = "bold", bg = "NONE"}),
        TabLineSel({ bg = "NONE", gui = "bold", fg = hsl(0, 0, 7) }),
        TabLineFill({ fg = hsl(42, 52, 56), bg = "NONE"}),
        ...
        DiagnosticSignError({ DiagnosticError, bg = "NONE"}),
        DiagnosticSignWarn({ DiagnosticWarn, bg = "NONE"}),
        DiagnosticSignInfo({ DiagnosticInfo, bg = "NONE"}),
        DiagnosticSignHint({ DiagnosticHint, bg = "NONE"}),
